...
class Comment {
  constructor(params) {
    ...
    this.currentClientWidth = 0
    this.currentClientHeight = 0
  ...
  add(params) {
    ...
    if (this.clientChanged) {
      this.currentClientWidth = area.clientWidth
      this.currentClientHeight = area.clientHeight
      this.clientChanged = false
    }

    // Calculate the number of line of comments as per the current height of commentArea dynamically
    const areaWidth = this.currentClientWidth
    const areaHeight = this.currentClientHeight
    ...
    if (this.currentItemIdx > this.threshold) {
    ...
    const transWidth = areaWidth + item.clientWidth
